...
with col_center:
    ...
    st.markdown("""
        ...
        <div class="social-icons-wrapper">
            <!-- Telegram -->
            <a href="https://t.me/+SAwDw59_ym7swlzf" class="icon-link" target="_blank">
            ...
            <!-- Twitch -->
            <a href="http://twitch.tv/juvandmeofficial" class="icon-link" target="_blank">
            ...
            <!-- YouTube -->
            <a href="https://www.youtube.com/@juvme8305" class="icon-link" target="_blank">
            ...
            <!-- X -->
            <a href="https://x.com/juvandme" class="icon-link" target="_blank">
